package com.example.portraitattest.info;


import com.example.portraitattest.model.BDFaceOcclusion;
import com.example.portraitattest.model.BDFaceSDKCommon;
...
public class FaceInfo {
    ...
    public FaceInfo(int faceID, float[] box, float[] landmarks,
        ...
        if (attr != null && attr.length == 6) {
            ...
            this.emotionSeven = BDFaceSDKCommon.BDFaceEmotionEnum.values()[attr[5]];
        }
